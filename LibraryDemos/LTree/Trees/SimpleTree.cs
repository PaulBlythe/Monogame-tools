...
namespace LTreesLibrary.Trees
{
    ...
    public class SimpleTree
    {
        ...
        /// This method sets all the appropriate effect parameters.
        /// </remarks>
        public void DrawLeaves(Matrix world, Matrix view, Matrix projection, bool forwardtech,bool depth = false)
        {
            if (skeleton == null)
            ...
            leaves.Draw(leafEffect, forwardtech, depth);
        }
        ...
        public void DrawBonesAsLines(Matrix world, Matrix view, Matrix projection)
        {
            ...
            boneEffect.CurrentTechnique.Passes[0].Apply();            
