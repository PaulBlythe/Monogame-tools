...
namespace LTreesLibrary.Trees
{
    ...
    public class TreeLineMesh : IDisposable
    {
        ...
        private void Init(TreeSkeleton skeleton)
        {
            ...
            // Create buffers
            vbuffer = new VertexBuffer(device, VertexPositionColor.VertexDeclaration, numvertices, BufferUsage.WriteOnly);
        ...
        public void Draw(Matrix world, Matrix view, Matrix projection)
        {
            ...
            device.DrawIndexedPrimitives(PrimitiveType.LineList, 0, 0, numlines);
        }
