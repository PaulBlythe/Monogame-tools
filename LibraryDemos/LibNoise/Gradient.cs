...
namespace LibNoise
{
	...
	public struct Gradient
	{
		...
		static Gradient()
		{
			...
			Gradient._empty.m_data.Add(new KeyValuePair<double, Color>(-1.0, Color.TransparentBlack));
			Gradient._empty.m_data.Add(new KeyValuePair<double, Color>(1.0, Color.TransparentBlack));
		...
		{
			this.m_data.Clear();
			this.m_data.Add(new KeyValuePair<double, Color>(0.0, Color.TransparentBlack));
			this.m_data.Add(new KeyValuePair<double, Color>(1.0, Color.TransparentBlack));
		}
