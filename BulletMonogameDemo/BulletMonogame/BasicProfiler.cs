...
namespace BulletMonogame
{
    ...
    public class CProfileNode 
    {
	    ...
	    public int m_recursionCounter;

	    public CProfileNode m_parent;
	    public CProfileNode m_child;
	    public CProfileNode m_sibling;
        public BasicProfileManager m_profileManager;
}
