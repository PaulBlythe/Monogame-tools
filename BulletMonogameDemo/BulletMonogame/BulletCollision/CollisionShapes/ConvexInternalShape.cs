...
namespace BulletMonogame.BulletCollision
{
    ...
    public abstract class ConvexInternalShape : ConvexShape
    {
        ...
        public IndexedVector3 m_implicitShapeDimensions;
    ...
    {
        public IndexedVector3 m_localAabbMin;
        public IndexedVector3 m_localAabbMax;
        public bool m_isLocalAabbValid;


        public void SetCachedLocalAabb(ref IndexedVector3 aabbMin, ref IndexedVector3 aabbMax)
        {
