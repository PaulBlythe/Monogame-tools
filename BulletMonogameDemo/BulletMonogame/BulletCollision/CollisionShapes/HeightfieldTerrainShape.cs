...
namespace BulletMonogame.BulletCollision
{
    ...
    {
        public BulletMonogame.LinearMath.IndexedVector3 m_localAabbMin;
        public IndexedVector3 m_localAabbMax;
        public IndexedVector3 m_localOrigin;

        ///terrain data
        public int m_heightStickWidth;
        public int m_heightStickLength;
        ...
        public byte[] m_heightFieldDataByte;
        public float[] m_heightFieldDataFloat;
        //union
        //{
        ...
        public PHY_ScalarType m_heightDataType;
        public bool m_flipQuadEdges;
        public bool m_useDiamondSubdivision;

        public int m_upAxis;

        public IndexedVector3 m_localScaling;

        public QuadTreeNode m_rootQuadTreeNode;
        public int m_minNodeSize;
        ...
        public virtual float GetRawHeightFieldValue(int x, int y)
        {
            float val = 0f;
        ...
        public void QuantizeWithClamp(int[] output, ref IndexedVector3 point, int isMax)
        {
        ...
        public void GetVertex(int x, int y, out IndexedVector3 vertex)
        {
            Debug.Assert(x >= 0);
            Debug.Assert(y >= 0);
