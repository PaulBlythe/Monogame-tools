...
namespace BulletMonogame.BulletCollision
{
    public class GImpactQuantizedBvh
    {
        ...
        public QuantizedBvhTree m_box_tree = new QuantizedBvhTree();
        public IPrimitiveManagerBase m_primitive_manager;
    ...
    {
        public int m_num_nodes;
        public GIM_QUANTIZED_BVH_NODE_ARRAY m_node_array = new GIM_QUANTIZED_BVH_NODE_ARRAY();
        public AABB m_global_bound;
        public IndexedVector3 m_bvhQuantization;

        public void CalcQuantization(GIM_BVH_DATA_ARRAY primitive_boxes)
        {
        ...
        public int SortAndCalcSplittingIndex(GIM_BVH_DATA_ARRAY primitive_boxes, int startIndex, int endIndex, int splitAxis)
        {
            int i;
        ...
        public int CalcSplittingAxis(GIM_BVH_DATA_ARRAY primitive_boxes, int startIndex, int endIndex)
        {
            int i;
