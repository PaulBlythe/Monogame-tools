...
namespace BulletMonogame.BulletCollision
{
    ...
    public abstract class GImpactShapeInterface : ConcaveShape
    {
        ...
        public bool m_needs_update;
        public IndexedVector3 localScaling;
        public GImpactQuantizedBvh m_box_set = new GImpactQuantizedBvh();// optionally boxset
        ...
        //! use this function for perfofm refit in bounding boxes
        public virtual void CalcLocalAABB()
        {
            LockChildShapes();
    ...
    */
    public class GImpactCompoundShape : GImpactShapeInterface
    {
        ...
        public CompoundPrimitiveManager m_primitive_manager;
        public ObjectArray<IndexedMatrix> m_childTransforms = new ObjectArray<IndexedMatrix>();

        //public ObjectArray<CollisionShape>	m_childShapes = new ObjectArray<CollisionShape>();
        // List here as collisionshape is abstract
        public List<CollisionShape> m_childShapes = new List<CollisionShape>();
    ...
    */
    public class GImpactMeshShapePart : GImpactShapeInterface
    {
        ...
        */
        ...
        public TrimeshPrimitiveManager m_primitive_manager = new TrimeshPrimitiveManager();
    ...
    */
    public class GImpactMeshShape : GImpactShapeInterface
    {
        ...
        public ObjectArray<GImpactMeshShapePart> m_mesh_parts = new ObjectArray<GImpactMeshShapePart>();
        ...
        //! use this function for perfofm refit in bounding boxes
        public override void CalcLocalAABB()
        {
            m_localAABB.Invalidate();
