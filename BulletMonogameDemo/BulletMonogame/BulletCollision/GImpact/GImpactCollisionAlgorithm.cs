...
namespace BulletMonogame.BulletCollision
{
    ...
    public class GImpactCollisionAlgorithm : ActivatingCollisionAlgorithm
    {
        ...
        public PersistentManifold GetLastManifold()
        {
            return m_manifoldPtr;
        }
        ...
        public void CheckManifold(CollisionObject body0, CollisionObject body1)
        {
        ...
        // Call before process collision
        public CollisionAlgorithm NewAlgorithm(CollisionObject body0, CollisionObject body1)
        {
        ...
        // Call before process collision
        public void CheckConvexAlgorithm(CollisionObject body0, CollisionObject body1)
        {
#if DEBUG        
        ...
        public void AddContactPoint(CollisionObject body0,
        ...
        public void CollideGjkTriangles(CollisionObject body0,
                      CollisionObject body1,
        ...
        public void GImpactVsShapeFindPairs(
                          ref IndexedMatrix trans0,
                          ref IndexedMatrix trans1,
                          GImpactShapeInterface shape0,
                          CollisionShape shape1,
        ...
        public void GImpactTrimeshpartVsPlaneCollision(
                          CollisionObject body0,
                          CollisionObject body1,
                          GImpactMeshShapePart shape0,
