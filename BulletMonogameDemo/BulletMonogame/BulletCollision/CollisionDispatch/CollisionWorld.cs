                ...
                default:
                    {
                        ...
                        if (shape.IsConcave())
                        {
                            ...
                            using (BulletMonogame.DebugDrawcallback drawCallback = BulletGlobals.DebugDrawcallbackPool.Get())
                            {
