...
namespace BulletMonogame.BulletCollision
{
	...
	if(BulletGlobals.g_streamWriter != null && BulletGlobals.debugBroadphase)
	{
        ...
        public int m_numHandles;						// number of active handles
        public int m_maxHandles;						// max number of handles
        public int m_LastHandleIndex;

        public SimpleBroadphaseProxy[] m_pHandles;						// handles pool

        public Object m_pHandlesRawPtr;
        public int m_firstFreeHandle;		// free handles list
