...
namespace BulletMonogame.BulletCollision
{
    ...
    public class HashedOverlappingPairCache : IOverlappingPairCache
    {
        ...
        */
        ...
        public ObjectArray<int> m_hashTable = new ObjectArray<int>();
        public ObjectArray<int> m_next = new ObjectArray<int>();


        public IOverlappingPairCallback m_ghostPairCallback;
    ...
    public class SortedOverlappingPairCache : IOverlappingPairCache
    {
        ...
        public ObjectArray<BroadphasePair> m_overlappingPairArray;

        //during the dispatch, check that user doesn't destroy/create proxy
        public bool m_blockedForChanges;

        ///by default, do the removal during the pair traversal
        public bool m_hasDeferredRemoval;

        //if set, use the callback instead of the built in filter in needBroadphaseCollision
        public IOverlapFilterCallback m_overlapFilterCallback;
