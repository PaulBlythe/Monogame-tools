...
namespace BulletMonogame.BulletCollision
{
    ...
    {
        public int m_bpHandleMask;
        public ushort m_handleSentinel;
        public IndexedVector3 m_worldAabbMin;						// overall system bounds
        public IndexedVector3 m_worldAabbMax;						// overall system bounds
        public IndexedVector3 m_quantize;						// scaling factor for quantization

        public ushort m_numHandles;						// number of active handles
        public ushort m_maxHandles;						// max number of handles
        public Handle[] m_pHandles;						// handles pool
        public ushort m_firstFreeHandle;		// free handles list

        public Edge[,] m_pEdges = null; // edge arrays for the 3 axes (each array has m_maxHandles * 2 + 2 sentinel entries)
        //public Object[] m_pEdgesRawPtr = new Object[3];

        public IOverlappingPairCache m_pairCache;

        ///btOverlappingPairCallback is an additional optional user callback for adding/removing overlapping pairs, similar interface to btOverlappingPairCache.
        public IOverlappingPairCallback m_userPairCallback;

        public bool m_ownsPairCache;

        public int m_invalidPair;

        ///additional dynamic aabb structure, used to accelerate ray cast queries.
        ///can be disabled using a optional argument in the constructor
        public DbvtBroadphase m_raycastAccelerator;
        public IOverlappingPairCache m_nullPairCache;
        ...
        public void FreeHandle(ushort handle)
        {
        ...
        public bool TestOverlap2D(Handle pHandleA, Handle pHandleB, int axis0, int axis1)
        {
...
#if DEBUG_BROADPHASE
	    public void debugPrintAxis(int axis)
        {
