...
namespace BulletMonogame.BulletDynamics
{
	...
	{
		public IndexedVector3 ComputeReflectionDirection(ref IndexedVector3 direction, ref IndexedVector3 normal)
		{
            return direction - (2.0f * direction.Dot(ref normal)) * normal;
		}

		public IndexedVector3 ParallelComponent(ref IndexedVector3 direction, ref IndexedVector3 normal)
		{
			float magnitude = IndexedVector3.Dot(direction, normal);
			return normal * magnitude;
		}
		public IndexedVector3 PerpindicularComponent(ref IndexedVector3 direction, ref IndexedVector3 normal)
		{
		...
		public void UpdateTargetPositionBasedOnCollision(ref IndexedVector3 hitNormal, float tangentMag, float normalMag)
		{
		...
		public PairCachingGhostObject m_ghostObject;
		public ConvexShape m_convexShape;//is also in m_ghostObject, but it needs to be convex, so we store it here to avoid upcast
		...
		public float m_maxSlopeRadians; // Slope angle that is set (used for returning the exact value)
		public float m_maxSlopeCosine;  // Cosine equivalent of m_maxSlopeRadians (calculated once when set, for optimization)
		...
		public float m_addedMargin;//@todo: remove this and fix the code

		///this is the desired walk direction, set by the user
		public IndexedVector3 m_walkDirection;
		public IndexedVector3 m_normalizedDirection;

		//some internal variables
		public IndexedVector3 m_currentPosition;
		float m_currentStepOffset;
		public IndexedVector3 m_targetPosition;

		///keep track of the contact manifolds
		public PersistentManifoldArray m_manifoldArray = new PersistentManifoldArray();

		public bool m_touchingContact;
		public IndexedVector3 m_touchingNormal;
		public bool m_wasOnGround;
		public bool m_wasJumping;

		public bool m_useGhostObjectSweepTest;

		public int m_upAxis;
		public bool m_useWalkDirection;
		public float m_velocityTimeInterval;




        public static IndexedVector3[] upAxisDirection = { new IndexedVector3(1, 0, 0), new IndexedVector3(0, 1, 0), new IndexedVector3(0, 0, 1) };
	...
	public class KinematicClosestNotMeConvexResultCallback : ClosestConvexResultCallback
	{
		...
		public CollisionObject m_me;
		public IndexedVector3 m_up;
		public float m_minSlopeDot;
	}
