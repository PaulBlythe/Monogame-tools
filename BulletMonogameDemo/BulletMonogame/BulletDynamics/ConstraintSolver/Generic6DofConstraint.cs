...
namespace BulletMonogame.BulletDynamics
{
	public class Generic6DofConstraint : TypedConstraint
	{
		...
		public virtual int SetAngularLimits(ConstraintInfo2 info, int row_offset, ref IndexedMatrix transA, ref IndexedMatrix transB, ref IndexedVector3 linVelA, ref IndexedVector3 linVelB, ref IndexedVector3 angVelA, ref IndexedVector3 angVelB)
		{
		...
		public virtual int SetLinearLimits(ConstraintInfo2 info, int row, ref IndexedMatrix transA, ref IndexedMatrix transB, ref IndexedVector3 linVelA, ref IndexedVector3 linVelB, ref IndexedVector3 angVelA, ref IndexedVector3 angVelB)
		{
			//solve linear limits
		...
		public virtual void BuildLinearJacobian(
		...
		public virtual void BuildAngularJacobian(out JacobianEntry jacAngular, ref IndexedVector3 jointAxisW)
		{
		...
		// tests linear limits
		public virtual void CalculateLinearInfo()
		{
		...
		public virtual void CalculateAngleInfo()
		{
		...
		*/
		...
		//! relative_frames
		//!@{
		public IndexedMatrix m_frameInA = IndexedMatrix.Identity; //!< the constraint space w.r.t body A
		public IndexedMatrix m_frameInB = IndexedMatrix.Identity; //!< the constraint space w.r.t body B
		//!@}

		//! Jacobians
		//!@{
		public JacobianEntry[] m_jacLinear = new JacobianEntry[3];//!< 3 orthogonal linear constraints
		public JacobianEntry[] m_jacAng = new JacobianEntry[3];//!< 3 orthogonal angular constraints
		//!@}

		//! Linear_Limit_parameters
		//!@{
		public TranslationalLimitMotor m_linearLimits;
		//!@}


		//! hinge_parameters
		//!@{
		public RotationalLimitMotor[] m_angularLimits = new RotationalLimitMotor[3];
		//!@}
		...
		public IndexedVector3 m_calculatedAxisAngleDiff;
		public IndexedVector3[] m_calculatedAxis = new IndexedVector3[3];
		public IndexedVector3 m_calculatedLinearDiff;
		public float m_factA;
		public float m_factB;
		public bool m_hasStaticBody;

		public IndexedVector3 m_AnchorPos; // point betwen pivots of bodies A and B to solve linear axes
