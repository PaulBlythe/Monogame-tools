...
namespace BulletMonogame.BulletDynamics
{
	public class SliderConstraint : TypedConstraint
	{
		...
		public bool m_useOffsetForConstraintFrame;

		public IndexedMatrix m_frameInA = IndexedMatrix.Identity;
		public IndexedMatrix m_frameInB = IndexedMatrix.Identity;
		// use frameA fo define limits, if true
		public bool m_useLinearReferenceFrameA;
		// linear limits
		public float m_lowerLinLimit;
		public float m_upperLinLimit;
		// angular limits
		public float m_lowerAngLimit;
		public float m_upperAngLimit;
		...
		public float m_softnessDirLin;
		public float m_restitutionDirLin;
		public float m_dampingDirLin;
		public float m_cfmDirLin;

		public float m_softnessDirAng;
		public float m_restitutionDirAng;
		public float m_dampingDirAng;
		public float m_cfmDirAng;

		public float m_softnessLimLin;
		public float m_restitutionLimLin;
		public float m_dampingLimLin;
		public float m_cfmLimLin;

		public float m_softnessLimAng;
		public float m_restitutionLimAng;
		public float m_dampingLimAng;
		public float m_cfmLimAng;

		public float m_softnessOrthoLin;
		public float m_restitutionOrthoLin;
		public float m_dampingOrthoLin;
		public float m_cfmOrthoLin;

		public float m_softnessOrthoAng;
		public float m_restitutionOrthoAng;
		public float m_dampingOrthoAng;
		public float m_cfmOrthoAng;

		// for interlal use
		public bool m_solveLinLim;
		public bool m_solveAngLim;

		public int m_flags;


		public JacobianEntry[] m_jacLin = new JacobianEntry[3];
		public float[] m_jacLinDiagABInv = new float[3];

		public JacobianEntry[] m_jacAng = new JacobianEntry[3];

		public float m_timeStep;
		public IndexedMatrix m_calculatedTransformA = IndexedMatrix.Identity;
		public IndexedMatrix m_calculatedTransformB = IndexedMatrix.Identity;

		public IndexedVector3 m_sliderAxis;
		public IndexedVector3 m_realPivotAInW;
		public IndexedVector3 m_realPivotBInW;
		public IndexedVector3 m_projPivotInW;
		public IndexedVector3 m_delta;
		public IndexedVector3 m_depth;
		public IndexedVector3 m_relPosA;
		public IndexedVector3 m_relPosB;

		public float m_linPos;
		public float m_angPos;

		public float m_angDepth;
		public float m_kAngle;

		public bool m_poweredLinMotor;
		public float m_targetLinMotorVelocity;
		public float m_maxLinMotorForce;
		public float m_accumulatedLinMotorImpulse;

		public bool m_poweredAngMotor;
		public float m_targetAngMotorVelocity;
		public float m_maxAngMotorForce;
		public float m_accumulatedAngMotorImpulse;
