...
namespace BulletMonogame.BulletDynamics
{
	public class SequentialImpulseConstraintSolver : IConstraintSolver
	{
		...
		public ObjectArray<SolverConstraint> m_tmpSolverContactConstraintPool;
		public ObjectArray<SolverConstraint> m_tmpSolverNonContactConstraintPool;
		public ObjectArray<SolverConstraint> m_tmpSolverContactFrictionConstraintPool;
		public ObjectArray<int> m_orderTmpConstraintPool;
        public ObjectArray<int> m_orderNonContactConstraintPool;
		public ObjectArray<int> m_orderFrictionConstraintPool;
		public ObjectArray<ConstraintInfo1> m_tmpConstraintSizesPool;
        public ObjectArray<ConstraintInfo2> m_tmpConstraintInfo2Pool;

        public int m_maxOverrideNumSolverIterations;
		...
		public ulong m_btSeed2;

		public int m_counter;

        public int m_lowerLimitCount = 0;
        public int m_genericCount = 0;
        public int m_setupCount = 0;
        public int m_iterCount = 0;
        public int m_finishCount = 0;
		...
		public void SetupContactConstraint(ref SolverConstraint solverConstraint, CollisionObject colObj0, CollisionObject colObj1, ManifoldPoint cp,
		...
		public void SetFrictionConstraintImpulse(ref SolverConstraint solverConstraint, RigidBody rb0, RigidBody rb1,
		...
		//public void initSolverBody(SolverBody solverBody, CollisionObject collisionObject)
		//{
		...
		public float RestitutionCurve(float rel_vel, float restitution)
		{
            // base on rest2 ?
		...
		public void ConvertContact(PersistentManifold manifold, ContactSolverInfo infoGlobal)
		{
		...
		//internal method
		public int GetOrInitSolverBody(CollisionObject body)
		{
			//int solverBodyA = -1;
		...
		public void ResolveSingleConstraintRowGeneric(RigidBody body1, RigidBody body2, ref SolverConstraint c)
		{
            m_genericCount++;
		...
		public void ResolveSingleConstraintRowLowerLimit(RigidBody body1, RigidBody body2, ref SolverConstraint c)
		{
            m_lowerLimitCount++;
		...
		public void ResolveSplitPenetrationImpulseCacheFriendly(
			RigidBody body1,
			RigidBody body2,
		...
		public virtual float SolveGroupCacheFriendlyFinish(ObjectArray<CollisionObject> bodies, int numBodies, PersistentManifoldArray manifold, int startManifold, int numManifolds, ObjectArray<TypedConstraint> constraints, int startConstraint, int numConstraints, ContactSolverInfo infoGlobal, IDebugDraw debugDrawer)
		{
            m_finishCount++;
			int numPoolConstraints = m_tmpSolverContactConstraintPool.Count;
        ...
        public virtual float SolveGroupCacheFriendlySetup(ObjectArray<CollisionObject> bodies, int numBodies, PersistentManifoldArray manifold, int startManifold, int numManifolds, ObjectArray<TypedConstraint> constraints, int startConstraint, int numConstraints, ContactSolverInfo infoGlobal, IDebugDraw debugDrawer, IDispatcher dispatcher)
		{
            m_setupCount++;
		...
		//public virtual float solveGroupCacheFriendlyIterations()
		public float SolveGroupCacheFriendlyIterations(ObjectArray<CollisionObject> bodies, int numBodies, PersistentManifoldArray manifoldPtr, int startManifold, int numManifolds, ObjectArray<TypedConstraint> constraints, int startConstraint, int numConstraints, ContactSolverInfo infoGlobal, IDebugDraw debugDrawer, IDispatcher dispatcher)
		{
            m_iterCount++;
        ...
        public float SolveSingleIteration(int iteration, ObjectArray<CollisionObject> bodies, int numBodies, PersistentManifoldArray manifold, int startManifold, int numManifolds, ObjectArray<TypedConstraint> constraints, int startConstraint, int numConstraints, ContactSolverInfo infoGlobal, IDebugDraw debugDrawer)
		{
            int numNonContactPool = m_tmpSolverNonContactConstraintPool.Count;
			int numConstraintPool = m_tmpSolverContactConstraintPool.Count;
			int numFrictionPool = m_tmpSolverContactFrictionConstraintPool.Count;
