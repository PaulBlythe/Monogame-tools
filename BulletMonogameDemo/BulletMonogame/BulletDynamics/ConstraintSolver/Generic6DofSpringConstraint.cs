...
namespace BulletMonogame.BulletDynamics
{
    public class Generic6DofSpringConstraint : Generic6DofConstraint
    {
        ...
        public void InternalUpdateSprings(ConstraintInfo2 info)
        {
        ...
        public bool[] m_springEnabled = new bool[s_degreesOfFreedom];
        public float[] m_equilibriumPoint = new float[s_degreesOfFreedom];
        public float[] m_springStiffness = new float[s_degreesOfFreedom];
        public float[] m_springDamping = new float[s_degreesOfFreedom]; // between 0 and 1 (1 == no damping)
