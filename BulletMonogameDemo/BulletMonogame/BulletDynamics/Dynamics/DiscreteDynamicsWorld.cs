...
namespace BulletMonogame.BulletDynamics
{
    public class DiscreteDynamicsWorld : DynamicsWorld
    {
        ...
        public virtual void InternalSingleStepSimulation(float timeStep)
        {
        ...
        public SimulationIslandManager m_islandManager;

        public ObjectArray<TypedConstraint> m_constraints;
        public ObjectArray<TypedConstraint> m_sortedConstraints;
        public SortConstraintOnIslandPredicate m_islandSortPredicate;
        public QuickSortConstraintOnIslandPredicate m_islandQuickSortPredicate;
        public ObjectArray<RigidBody> m_nonStaticRigidBodies;


        public IndexedVector3 m_gravity;

        //for variable timesteps
        public float m_localTime;
        //for variable timesteps

        public bool m_ownsIslandManager;
        public bool m_ownsConstraintSolver;
        public bool m_synchronizeAllMotionStates;

        public IList<IActionInterface> m_actions;

        public int m_profileTimings;
        public int gNumClampedCcdMotions;
        public const float s_fixedTimeStep = 1f / 60f;
        //public const float s_fixedTimeStep = 0.016666668f;
        //public float s_fixedTimeStep2 = 1 / 60;
        //public float s_fixedTimeStep3 = (float)(1.0 / 60.0);
        //public float s_fixedTimeStep4 = 0.016666668f;
