...
using BulletMonogame.BulletCollision.CollisionDispatch;
...
namespace BulletMonogameDemo.Demos
{
    public class InternalEdgeDemo : DemoApplication
    {
        ...
        public override void InitializeDemo()
        {
            ...
            m_debugDraw = Game1.Instance.shape_drawer;
    ...
    public class CustomMaterialCombinerCallback : IContactAddedCallback
    {
        ...
        public bool Callback(ref ManifoldPoint cp, CollisionObject colObj0, int partId0, int index0, CollisionObject colObj1, int partId1, int index1)
        {
            bool enable = true;
           	if (enable)
	        {
		        InternalEdgeUtility.AdjustInternalEdgeContacts(cp,colObj1,colObj0, partId1,index1, BulletMonogame.BulletCollision.CollisionDispatch.InternalEdgeUtility.InternalEdgeAdjustFlags.BT_TRIANGLE_CONVEX_BACKFACE_NONE);
